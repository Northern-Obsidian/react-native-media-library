...
import { getDocuments, getFolders, DocumentItem, Folder } from "@cadmus11/mediastore";
      ...
      <FlatList
              ...
              {folders.map((f) => (
                <View key={f.id} style={styles.row}>
                  ...
                  <Text style={styles.meta}>
                    {f.fileCount} files · {formatSize(f.totalSize)}
                  </Text>
                </View>
              ))}
            </View>
        ...
        renderItem={({ item }) => (
          <View style={styles.row}>
            ...
            <Text style={styles.meta}>
              {item.extension?.toUpperCase()} · {formatSize(item.size)}
            </Text>
          </View>
        )}
      />
